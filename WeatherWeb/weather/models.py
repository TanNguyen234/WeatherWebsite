...
class UserLocation(models.Model):
    ...
    class Meta:
        db_table = 'user_location' # Ép map đúng tên bảng SQL
        indexes = [
...
class LocationGroupItem(models.Model):
    # Khớp với bảng location_group_item
    ...
    class Meta:
        ...
        unique_together = ('group', 'location') # Khớp uq_group_location
